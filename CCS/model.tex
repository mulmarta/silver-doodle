...
%\footnote{We
%  note that if a simulator $\ucsim$ could make \textit{cond} false, then we would quantify over an empty set of environments, making the statement void. In our case, $\ucsim$ cannot do this.}
